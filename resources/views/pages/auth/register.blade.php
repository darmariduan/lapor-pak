...
@section('content')
    ...
    <form action="{{ route('auth.register.store') }}" method="POST" class="mt-4" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <button class="btn btn-primary w-100 mt-2" type="submit" color="primary" id="btn-register">
            Daftar
        </button>
